...
CREATE TABLE `commerciale` (
  ...
  `nome_ref` varchar(45) DEFAULT NULL,
  `cognome_ref` varchar(45) DEFAULT NULL,
  `telefono` varchar(45) NOT NULL,
  `p_iva` varchar(45) DEFAULT NULL,
  KEY `FK_181` (`indirizzo_id`),
  KEY `FK_40` (`id`),
  CONSTRAINT `FK_179` FOREIGN KEY (`indirizzo_id`) REFERENCES `indirizzo` (`id`)
